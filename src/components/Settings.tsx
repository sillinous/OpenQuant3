    ...
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-zinc-950 border border-zinc-800 rounded-2xl w-full max-w-md overflow-hidden shadow-2xl">
            ...
            <div className="space-y-3">
              <div>
                <label className="flex justify-between text-xs text-zinc-400 mb-1">
                  ...
                  <span className="font-mono text-zinc-300">0.1%</span>
                </label>
                <input type="range" min="0.05" max="1" step="0.05" defaultValue="0.1" className="w-full accent-emerald-500" />
              </div>

              <div>
                <label className="flex justify-between text-xs text-zinc-400 mb-1">
                  <span>Lookback Period</span>
                  <span className="font-mono text-zinc-300">20 Candles</span>
                </label>
                <input type="range" min="5" max="100" step="5" defaultValue="20" className="w-full accent-emerald-500" />
              </div>
            </div>
          </div>
            ...
            <div className="space-y-3">
              <div>
                <label className="flex justify-between text-xs text-zinc-400 mb-1">
                  ...
                  <span className="font-mono text-zinc-300">2.0%</span>
                </label>
                <input type="range" min="0.5" max="10" step="0.5" defaultValue="2.0" className="w-full accent-rose-500" />
              </div>
              ...
              <div>
                ...
                <input type="range" min="0.5" max="5" step="0.1" defaultValue="1.0" className="w-full accent-rose-500" />
              </div>
        ...
        <div className="p-4 border-t border-zinc-800/50 bg-zinc-900/30 flex justify-end gap-3">
          ...
          <button onClick={onClose} className="px-4 py-2 bg-emerald-500 hover:bg-emerald-600 text-zinc-950 text-sm font-semibold rounded-lg transition-colors flex items-center gap-2">
